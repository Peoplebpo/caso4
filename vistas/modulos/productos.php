                           ...
                           <div class="container-fluid my-3">
                              ...
                              <div class="row">
                                  ...
                                  <div class="col d-grid gap-2 d-md-flex justify-content-md-end">
                                      ...
                                      <button id="btnguardar" type="button" class="btn btn-info text-white"  data-bs-toggle="modal">Agregar Productos</button>
                ...
                <form id="formproductos">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control input-lg" placeholder="Ingresar precio" id="precio" required>
