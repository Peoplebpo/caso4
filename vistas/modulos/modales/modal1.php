...
<div class="modal fade" id="modalCRUD" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            ...
            <h5 class="modal-title" id="exampleModalLabel">VENTAS EN FRIO REFERIDOS</h5>
            ...
            <div class="modal-body" id="grabaciones">
                ...
                <div class="row">
                    ...
                    <input type="text" class="form-control" id="campana1" style="background: #C9D218 !important;" disabled>
                    </div> 
                    </div> 
                ...
                <div class="row">
                      ...
                      <div class="col-lg-3">
                      <div class="form-group">
                      <label for="" class="col-form-label"><strong>NUMERO AGENTE</strong></label>
                      <input type="text" class="form-control" id="numero_agente" style="background: #C9D218 !important;" disabled>
                      </div>
                      </div>
                      
                      <div class="col-lg-3">
                      <div class="form-group">
                      <label for="" class="col-form-label"><strong>EMAIL AGENTE</strong></label>
                      <input type="text" class="form-control" id="email_agente" style="background: #C9D218 !important;" disabled>
                      </div> 
                      </div> 
              ...
              <div style="text-align: center; " data-toggle="tooltip" title="Reproducir">
