        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Sub Productos</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                           ...
                           <div class="container-fluid my-3">
                              ...
                              <div class="row">
                                  ...
                                  <div class="col d-grid gap-2 d-md-flex justify-content-md-end">
                                      ...
                                      <button id="btnguardar" type="button" class="btn btn-info text-white"  data-bs-toggle="modal">Agregar Sub Producto</button>
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control input-lg" placeholder="Ingresar Precio" id="precio" required>
